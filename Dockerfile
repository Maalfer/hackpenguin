...
RUN apt update && apt upgrade -y && \
    apt install -y curl git nmap net-tools hydra golang nano wget sqlmap iputils-ping zsh dnsrecon subfinder wpscan whois dirb gobuster wfuzz impacket-scripts seclists smbclient smbmap python3 python3-pip python3-venv pipx
